...
import { DEFAULTS, SAFETY } from "./config-defaults.js";
 ...
 *   2. database overrides  what the user changed in the web console
 *   3. environment         deployment-level escape hatch
 *
 * SAFETY is applied last and cannot be overridden by any of them.
 */
export function resolveConfig({ overrides = null } = {}) {
...
export function bootstrapDatabasePath() {
  ...
  return path.resolve(ROOT, DEFAULTS.storage.database_path);
}
